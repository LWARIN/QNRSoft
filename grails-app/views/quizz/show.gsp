	...
	<body>
		...
		<div class="nav" role="navigation">
			<ul>
				...
				<shiro:isNotLoggedIn><li class="log"><g:link controller="auth" action="login" params="[targetUri: '/quizz/show/' + quizzInstance?.id]">Sign in</g:link></li></shiro:isNotLoggedIn>
			</ul>
		</div>
