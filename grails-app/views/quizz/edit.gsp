...
<html>
	<head>
		...
		<title>QnR - Edit Quizz</title>
	</head>
	<body>
		<a href="#edit-quizz" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="edit-quizz" class="content scaffold-edit" role="main">
			<h1>Edit Quizz</h1>
